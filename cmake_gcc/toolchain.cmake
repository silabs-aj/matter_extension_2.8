...
elseif(WIN32)
  set(TOOLCHAIN_DIR "C:/Users/alji/SimplicityStudio/SDKs/simplicity_sdk_5/extension/matter_extension/slc/tools/gcc//bin/")
elseif(APPLE)
...
elseif(WIN32)
  set(POST_BUILD_EXE "C:/Users/alji/.silabs/slt/installs/archive/Simplicity Commander/commander.exe")
elseif(APPLE)
  set(POST_BUILD_EXE "")
else()
  set(POST_BUILD_EXE "")
...
elseif(WIN32)
  set(NINJA_RUNTIME_PATH "C:/Users/alji/.silabs/slt/installs/conan/p/ninja1a38fc85adcf7/p/ninja.exe")
elseif(APPLE)
